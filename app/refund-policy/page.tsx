...
const styles = `
  ...
  *, *::before, *::after { margin: 0; padding: 0; box-sizing: border-box; }
  ...
  .summary-card { background:linear-gradient(135deg,rgba(74,0,128,0.2),rgba(26,0,37,0.8));
  ...
  .summary-card-title { font-family:'Cinzel',serif; font-size:14px; font-weight:700; color:white; margin-bottom:6px; }
  .summary-card-text { font-size:13px; color:rgba(255,255,255,0.45); line-height:1.6; }
  ...
  .warning-box { background:rgba(255,100,0,0.08); border:1px solid rgba(255,100,0,0.25); border-radius:12px; padding:18px 20px; margin-bottom:16px; }
  .warning-box p { margin-bottom:0; color:rgba(255,200,150,0.8); }
  ...
  .cta-title { font-family:'Cinzel',serif; font-size:clamp(20px,2.5vw,28px); font-weight:700; color:white; margin-bottom:12px; }
  .cta-sub { color:rgba(255,255,255,0.5); font-size:14px; margin-bottom:28px; }
  .cta-btns { display:flex; gap:14px; justify-content:center; flex-wrap:wrap; }
  .btn-wa { background:linear-gradient(135deg,#25d366,#128c7e); color:white; padding:13px 30px; border-radius:50px; text-decoration:none; font-size:14px; font-weight:600; transition:all 0.3s; }
